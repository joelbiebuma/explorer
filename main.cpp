...
main(int ac, const char* av[])
{
    ...
    if (testnet && deamon_url == "http:://127.0.0.1:38381")
        deamon_url = "http:://127.0.0.1:38384";
    if (stagenet && deamon_url == "http:://127.0.0.1:38381")
        deamon_url = "http:://127.0.0.1:38387";
    ...
    if (enable_emission_monitor == true)
    {
        ...
        // e.g., ~/.txchangecoin/lmdb/emission_amount.txt.
